"""This is an model to check influence based friendships between agents.

Agents have opinions, resistance to change, and influence over others.
Agents can form friendships based on similarity in influence.
If the difference in influence between two agents exceeds a certain threshold, they will cease to be friends.
"""
...
class Agent:
    ...
    def __init__(self, id: int, opinion: float, resistance: float, influence: float):
        ...
        self.friends: list[Agent] = []  # List to hold friends (other Agent instances)
    ...
    def interact(self, buddy):
        ...
        print(
            f"Agent {self.id} interacting with Agent {buddy.id}: influence difference = {influence_diff}"
        )
...
print(
    f"Agent {a1.id} opinion: {a1.opinion}, resistance: {a1.resistance}, influence: {a1.influence}"
)
print(
    f"Agent {a2.id} opinion: {a2.opinion}, resistance: {a2.resistance}, influence: {a2.influence}"
)
print(
    f"Agent {a3.id} opinion: {a3.opinion}, resistance: {a3.resistance}, influence: {a3.influence}"
)
print(
    f"Agent {a4.id} opinion: {a4.opinion}, resistance: {a4.resistance}, influence: {a4.influence}"
)
print(
    f"Agent {a5.id} opinion: {a5.opinion}, resistance: {a5.resistance}, influence: {a5.influence}"
)
